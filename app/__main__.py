...
class NutritionApp(Tk):
    def __init__(self):
        ...
        self.iconbitmap('dist/resources/logosmall.ico')
    ...
    def initImage(self):
        imguh = Image.open("dist/resources/login.png")
